// app/ResidentialInterior/ApartmentInteriorDesign/sections/HeroSection/HeroSection.tsx
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        <img
          ...
          alt="Apartment Interior Design Hero"
          src="/image.png"
        />
      </div>
      ...
      <div className="absolute inset-0 bg-black/40 flex items-center justify-start">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-left text-white max-w-4xl">
            {/* Title */}
            <div ref={titleWrapperRef} className="perspective-[1000px] cursor-default">
              <motion.h1
                ref={titleRef}
            ...
            >
              <Link to="/" className="text-white/80 hover:text-white text-sm sm:text-base">
                Home
              </Link>
              ...
              <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4 text-white/60" />
              <span className="text-white/80 text-sm sm:text-base">Residential</span>
              <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4 text-white/60" />
