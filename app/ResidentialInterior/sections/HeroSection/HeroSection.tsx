...
export const HeroSection = (): JSX.Element => {
  ...
  // Add hover animation for page title
  useEffect(() => {
    ...
    if (titleWrapperRef.current) {
      titleWrapperRef.current.addEventListener('mousemove', (e) => {
      ...
      titleWrapperRef.current.addEventListener('mouseleave', () => {
        gsap.to(splitText.chars, {
          duration: 1,
          y: 0,
          x: 0,
    ...
    return () => {
      splitText.revert();
      if (titleWrapperRef.current) {
        titleWrapperRef.current.removeEventListener('mousemove', () => {});
        titleWrapperRef.current.removeEventListener('mouseleave', () => {});
      }
    };
  }, []);
